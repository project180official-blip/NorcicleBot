...
BINANCE_QR_URL = os.environ.get("BINANCE_QR_URL", "").strip()
...
QR_URL_USDT = os.environ.get("QR_URL_USDT", "").strip()
QR_URL_USDC_SOL = os.environ.get("QR_URL_USDC_SOL", "").strip()
...
ADMIN_USERNAME = os.environ.get("ADMIN_USERNAME", "nolejass").strip().lstrip("@")
...
BANNER_URL = os.environ.get(
    "BANNER_URL",
    "https://i.ibb.co.com/Q3SJBxNn/Chat-GPT-Image-Sep-6-2026-06-36-09-AM.png",
).strip()
